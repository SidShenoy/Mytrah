...
<%
				...
				try
				{
					...
					command = new StringBuilder("cmd /c cd C:\\Users\\Siddhanth\\Documents\\JSPProjectDocuments\\parametersandstuff\\SomeFiles\\"+lat+"_"+lon+" & ncks -d lon,77.4,77.6 -d lat,20.4,20.6 1980."+currenttime+".nc 20.5_77.5."+currenttime+".nc");	
					...
					command = new StringBuilder("cmd /c cd C:\\Users\\Siddhanth\\Documents\\JSPProjectDocuments\\parametersandstuff\\SomeFiles\\"+lat+"_"+lon+" & copy 20.5_77.5."+currenttime+".nc Final");	
								
					process = Runtime.getRuntime().exec(command.toString());
					
					process.waitFor();
					
					//the next 3 lines delete the file 20.5_77.5.currenttime.nc present in SomeFiles
					
					command = new StringBuilder("cmd /c cd C:\\Users\\Siddhanth\\Documents\\JSPProjectDocuments\\parametersandstuff\\SomeFiles\\"+lat+"_"+lon+" & del /Q 20.5_77.5."+currenttime+".nc");	
					...
					command = new StringBuilder("cmd /c cd C:\\Users\\Siddhanth\\Documents\\JSPProjectDocuments\\parametersandstuff\\SomeFiles\\"+lat+"_"+lon+"\\Final & ncdump 20.5_77.5."+currenttime+".nc >> testing1."+currenttime+".txt");	
								
					process = Runtime.getRuntime().exec(command.toString());
					
					process.waitFor();
					
					//the next 3 lines delete the file 20.5_77.5.currenttime.nc present in Final
					
					command = new StringBuilder("cmd /c cd C:\\Users\\Siddhanth\\Documents\\JSPProjectDocuments\\parametersandstuff\\SomeFiles\\"+lat+"_"+lon+"\\Final & del /Q 20.5_77.5."+currenttime+".nc");	
